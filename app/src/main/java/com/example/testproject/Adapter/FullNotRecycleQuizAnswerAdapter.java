...
public class FullNotRecycleQuizAnswerAdapter extends RecyclerView.Adapter<FullNotRecycleQuizAnswerAdapter.ansViewHolder> {
    ...
    public FullNotRecycleQuizAnswerAdapter(Context context, List<AnswerSetGet> ansList, String question, String questionId, Button btn_save_next, Integer selectedPosition) {
    ...
    @NonNull
    @Override
    public FullNotRecycleQuizAnswerAdapter.ansViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        assert inflater != null;
        View view = inflater.inflate(R.layout.custom_gk_answer_list_layout, parent, false);
        return new FullNotRecycleQuizAnswerAdapter.ansViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final FullNotRecycleQuizAnswerAdapter.ansViewHolder viewHolder, int position) {
